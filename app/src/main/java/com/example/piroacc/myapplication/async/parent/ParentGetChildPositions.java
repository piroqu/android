...
public class ParentGetChildPositions extends AsyncTask<Integer, Void, List<PositionForParentMDTOResponse>> {
    ...
    public List<PositionForParentMDTOResponse> getForPositions(Integer childId) {
    ...
    @Override
    protected List<PositionForParentMDTOResponse> doInBackground(Integer... params) {
        return getForPositions(params[0]);
    }
}
